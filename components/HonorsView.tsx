                    ...
                    >
                      ...
                      <div className="p-3.5">
                        <div className="flex items-start gap-3">
                          ...
                          >
                            {ach.icon && ach.icon.startsWith("/") ? <img src={ach.icon} alt="" width={28} height={28} style={{ imageRendering: "auto", filter: highlight || (!playerName && anyEarned) ? "none" : "grayscale(1) brightness(0.5)" }} /> : <span className="text-2xl" style={{ filter: highlight || (!playerName && anyEarned) ? "none" : "grayscale(1) brightness(0.5)" }}>{ach.icon}</span>}
                          </div>
